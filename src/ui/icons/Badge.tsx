...
const Badge: FC<BadgeProps> = ({
  ...
  return <svg xmlns='http://www.w3.org/2000/svg' viewBox='36 33 23 23'>
    ...
    <g fill={color}>
      ...
      || (value === 1 && <path d='M44.4 39h4.4v8.8H51V50h-6.6v-2.2h2.2v-6.6h-2.2z'/>)
      || (value === 2 && <path d='M43.1 40.1h1.1V39h6.6v1.1h1.1v4.4h-1.1v1.1h-5.5v2.2h6.6V50h-8.8v-5.5h1.1v-1.1h5.5v-2.2h-4.4v1.1h-2.2z'/>)
      || (value === 3 && <path d='M43.1 40.1h1.1V39h6.6v1.1h1.1v3.3h-1.1v2.2h1.1v3.3h-1.1V50h-6.6v-1.1h-1.1v-2.2h2.2v1.1h4.4v-2.2h-4.4v-2.2h4.4v-2.2h-4.4v1.1h-2.2z'/>)
      || (value === 4 && <path d='M43.1 39h2.2v4.4h4.4V39h2.2v11h-2.2v-4.4h-6.6z'/>)
      || (value === 5 && <path d='M42.9 39h8.8v2.2h-6.6v2.2h5.5v1.1h1.1v4.4h-1.1V50H44v-1.1h-1.1v-2.2h2.2v1.1h4.4v-2.2h-6.6z'/>)
      || (value === 6 && <path d='M43.1 40.1h1.1V39h6.6v1.1h1.1v2.2h-2.2v-1.1h-4.4v2.2h5.5v1.1h1.1v4.4h-1.1V50h-6.6v-1.1h-1.1v-8.8zm2.2 7.7h4.4v-2.2h-4.4v2.2z'/>)
