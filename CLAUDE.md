...
This project is indexed by GitNexus as **Rocket.Chat.Electron** (6255 symbols, 12394 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
