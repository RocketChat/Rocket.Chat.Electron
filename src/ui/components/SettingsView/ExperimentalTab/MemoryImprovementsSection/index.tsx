      ...
      <Field>
        <FieldRow>
          <FieldLabel htmlFor={memoryImprovementsId}>
            {t(
              'settings.experimental.memoryImprovements.title',
              'Memory Improvements'
            )}
          </FieldLabel>
          <ToggleSwitch
        ...
        <FieldRow>
          <FieldHint>
            {t(
              'settings.experimental.memoryImprovements.description',
      ...
      {memorySettings.enabled && (
        <>
          ...
          <Box marginBlock='x24'>
            <MemoryToggle
              label={t(
                'settings.experimental.memoryImprovements.features.monitoring',
                'Memory Monitoring'
              )}
              description={t(
                'settings.experimental.memoryImprovements.features.monitoringDesc',
            ...
            {memorySettings.features.monitoring && (
              <MemoryToggle
                label={t(
                  'settings.experimental.memoryImprovements.features.statusBar',
                  'Show in Title Bar'
                )}
                description={t(
                  'settings.experimental.memoryImprovements.features.statusBarDesc',
            ...
            <MemoryToggle
              label={t(
                'settings.experimental.memoryImprovements.features.smartCleanup',
                'Smart Cleanup'
              )}
              description={t(
                'settings.experimental.memoryImprovements.features.smartCleanupDesc',
            ...
            <MemoryToggle
              label={t(
                'settings.experimental.memoryImprovements.features.autoReload',
                'Auto-reload Protection'
              )}
              description={t(
                'settings.experimental.memoryImprovements.features.autoReloadDesc',
            ...
            <MemoryToggle
              label={t(
                'settings.experimental.memoryImprovements.features.domOptimization',
                'DOM Optimization'
              )}
              description={t(
                'settings.experimental.memoryImprovements.features.domOptimizationDesc',
            ...
            <MemoryToggle
              label={t(
                'settings.experimental.memoryImprovements.features.websocket',
                'WebSocket Management'
              )}
              description={t(
                'settings.experimental.memoryImprovements.features.websocketDesc',
