...
| 2    | In the left vertical server list, click Workspace A's icon to make it the active tab. Right-click the tray icon (Windows notification area / Linux system tray) to open the menu.                                                                                       | Active tab: Workspace A                         | The tray icon shows the online dot (`#2DE0A5` filled) and the tray menu's checked radio is `Online`.                                                                                                                    | Read `selectActiveServerPresence` and assert `url` matches Workspace A and `presence === 'online'`.      |
...
| 4    | With Workspace B still active, right-click the tray icon and click the `Online` radio item.                                                                                                                                                                             | Target presence: online, applied to Workspace B | The tray icon/menu for the active tab (Workspace B) show `Online` checked.                                                                                                                                              | Confirm the presence-change IPC targets Workspace B's `webContentsId`.                                   |
