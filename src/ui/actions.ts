...
export const SETTINGS_SET_WEBRTC_HIDE_LOCAL_IPS_ENABLED_CHANGED =
  'settings/set-webrtc-hide-local-ips-enabled-changed';
...
export type UiActionType =
  | typeof ABOUT_DIALOG_DISMISSED
  | typeof ABOUT_DIALOG_TOGGLE_UPDATE_ON_START
  | typeof ABOUT_DIALOG_UPDATE_CHANNEL_CHANGED
  | typeof ADD_SERVER_VIEW_SERVER_ADDED
  | typeof CLEAR_CACHE_TRIGGERED
  | typeof CLEAR_CACHE_DIALOG_DISMISSED
  | typeof CLEAR_CACHE_DIALOG_DELETE_LOGIN_DATA_CLICKED
  | typeof CLEAR_CACHE_DIALOG_KEEP_LOGIN_DATA_CLICKED
  | typeof LOADING_ERROR_VIEW_RELOAD_SERVER_CLICKED
  | typeof MENU_BAR_ABOUT_CLICKED
  | typeof MENU_BAR_ADD_NEW_SERVER_CLICKED
  | typeof MENU_BAR_SELECT_SERVER_CLICKED
  ...
  | typeof MENU_BAR_TOGGLE_IS_DEVELOPER_MODE_ENABLED_CLICKED
  | typeof ROOT_WINDOW_ICON_CHANGED
  | typeof ROOT_WINDOW_STATE_CHANGED
  | typeof VIDEO_CALL_WINDOW_STATE_CHANGED
  | typeof SIDE_BAR_ADD_NEW_SERVER_CLICKED
  | typeof SIDE_BAR_CONTEXT_MENU_TRIGGERED
  | typeof SIDE_BAR_DOWNLOADS_BUTTON_CLICKED
  | typeof SIDE_BAR_SETTINGS_BUTTON_CLICKED
  | typeof SIDE_BAR_REMOVE_SERVER_CLICKED
  | typeof SIDE_BAR_SERVER_SELECTED
  | typeof SIDE_BAR_SERVERS_SORTED
  ...
  | typeof TOUCH_BAR_FORMAT_BUTTON_TOUCHED
  | typeof TOUCH_BAR_SELECT_SERVER_TOUCHED
  | typeof UPDATE_DIALOG_DISMISSED
  | typeof UPDATE_DIALOG_INSTALL_BUTTON_CLICKED
  | typeof UPDATE_DIALOG_REMIND_UPDATE_LATER_CLICKED
  | typeof UPDATE_DIALOG_SKIP_UPDATE_CLICKED
  | typeof WEBVIEW_READY
  | typeof WEBVIEW_ATTACHED
  | typeof WEBVIEW_DID_FAIL_LOAD
  | typeof WEBVIEW_DID_NAVIGATE
  | typeof WEBVIEW_DID_START_LOADING
  | typeof WEBVIEW_FAVICON_CHANGED
  | typeof WEBVIEW_FOCUS_REQUESTED
  | typeof WEBVIEW_MESSAGE_BOX_BLURRED
  | typeof WEBVIEW_MESSAGE_BOX_FOCUSED
  | typeof WEBVIEW_SCREEN_SHARING_SOURCE_REQUESTED
  | typeof WEBVIEW_SCREEN_SHARING_SOURCE_RESPONDED
  | typeof WEBVIEW_SIDEBAR_STYLE_CHANGED
  | typeof WEBVIEW_SIDEBAR_CUSTOM_THEME_CHANGED
  | typeof WEBVIEW_TITLE_CHANGED
  | typeof WEBVIEW_PAGE_TITLE_CHANGED
  | typeof WEBVIEW_UNREAD_CHANGED
  | typeof WEBVIEW_USER_LOGGED_IN
  | typeof WEBVIEW_USER_THEME_APPEARANCE_CHANGED
  | typeof WEBVIEW_ALLOWED_REDIRECTS_CHANGED
  ...
  | typeof SETTINGS_SET_WEBRTC_HIDE_LOCAL_IPS_ENABLED_CHANGED
  | typeof SETTINGS_SET_INTERNALVIDEOCHATWINDOW_OPT_IN_CHANGED
  | typeof SETTINGS_SET_MINIMIZE_ON_CLOSE_OPT_IN_CHANGED
  | typeof SETTINGS_SET_IS_TRAY_ICON_ENABLED_CHANGED
  | typeof SETTINGS_SET_IS_SIDE_BAR_ENABLED_CHANGED
  | typeof SETTINGS_SET_IS_MENU_BAR_ENABLED_CHANGED
  | typeof SETTINGS_SET_IS_VIDEO_CALL_WINDOW_PERSISTENCE_ENABLED_CHANGED
  | typeof SETTINGS_SET_IS_DEVELOPER_MODE_ENABLED_CHANGED
  | typeof SETTINGS_CLEAR_PERMITTED_SCREEN_CAPTURE_PERMISSIONS
  | typeof SETTINGS_NTLM_CREDENTIALS_CHANGED
  | typeof SETTINGS_AVAILABLE_BROWSERS_UPDATED
  | typeof SETTINGS_SELECTED_BROWSER_CHANGED
  | typeof SET_HAS_TRAY_MINIMIZE_NOTIFICATION_SHOWN
  | typeof VIDEO_CALL_WINDOW_OPEN_URL
  | typeof DOWNLOADS_BACK_BUTTON_CLICKED
  | typeof WEBVIEW_SERVER_SUPPORTED_VERSIONS_UPDATED
  | typeof WEBVIEW_SERVER_UNIQUE_ID_UPDATED
  | typeof WEBVIEW_SERVER_IS_SUPPORTED_VERSION
  | typeof WEBVIEW_SERVER_VERSION_UPDATED
  | typeof SUPPORTED_VERSION_DIALOG_DISMISS
  | typeof WEBVIEW_SERVER_RELOADED
  | typeof WEBVIEW_PDF_VIEWER_ATTACHED
  | typeof CLEAR_PERMITTED_SCREEN_CAPTURE_SERVERS_CLICKED;

export type UiAction = Action<UiActionType> & { payload?: unknown };

export const CLEAR_PERMITTED_SCREEN_CAPTURE_SERVERS_CLICKED =
  'CLEAR_PERMITTED_SCREEN_CAPTURE_SERVERS_CLICKED';
...
export type UiActionTypeToPayloadMap = {
  ...
  [SETTINGS_SET_WEBRTC_HIDE_LOCAL_IPS_ENABLED_CHANGED]: boolean;
