...
gulp.task('build-unit', ['environment'], () => {
    return generateEntryFile('src', 'specs.js.autogenerated', '*.spec.js')
        .then((entryFilePath) => {
            return bundle(entryFilePath, 'app/specs.js.autogenerated', {
                rollupPlugins: [
                    istanbul({
...
gulp.task('build-e2e', [ 'build' ], () => {
    return generateEntryFile('e2e', 'e2e.js.autogenerated', '*.e2e.js')
        .then(function (entryFilePath) {
            return bundle(entryFilePath, 'app/e2e.js.autogenerated');
        });
});
