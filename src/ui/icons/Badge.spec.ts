...
describe('Badge', () => {
  ...
  it('renders the numeric branches 1 through 10', () => {
    expect(badgeMarkup(1)).toContain('M44.4 39h4.4v8.8H51V50h-6.6v-2.2h2.2v-6.6h-2.2z');
    ...
    expect(badgeMarkup(4)).toContain('M43.1 39h2.2v4.4h4.4V39h2.2v11h-2.2v-4.4h-6.6z');
    ...
    expect(badgeMarkup(7)).toContain('M42.8 40.1h1.1V39h6.6v1.1h1.1V50h-2.2v-8.8H45v3.3h-2.2z');
